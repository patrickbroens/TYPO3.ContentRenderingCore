<?php
namespace PatrickBroens\ContentRenderingCore\Updates;
...
class ContentTypesToTextMediaUpdate extends AbstractUpdate
{
     ...
     * @var string
     */
    protected $title = 'Migrate CTypes text, image and textpic to textmedia and move file relations from "image" to "assets"';
    ...
    public function checkForUpdate(&$description)
    {
        ...
        if (
            !ExtensionManagementUtility::isLoaded('content_rendering_core')
        ...
        $description = 'The extension "content_rendering_core" is using a new CType, textmedia, ' .
