<?php
namespace PatrickBroens\ContentRenderingCore\Resource\Rendering;
...
class RendererRegistry implements \TYPO3\CMS\Core\SingletonInterface
{
    ...
    {
        return GeneralUtility::makeInstance(\PatrickBroens\ContentRenderingCore\Resource\Rendering\RendererRegistry::class);
    }
    ...
    public function registerRendererClass($className)
    {
        ...
        } elseif (!in_array(\PatrickBroens\ContentRenderingCore\Resource\Rendering\FileRendererInterface::class, class_implements($className), true)) {
