...
With this content element you can provide unordered and ordered bullet lists, but also a definition list, in the
frontend.
...
For definition lists you use one line for a single definition which starts with the term, followed by the description,
...
The type of list can be defined with the field ``Type of bullets``, available in the ``Appearance`` tab.
