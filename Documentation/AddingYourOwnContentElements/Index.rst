...
`this page <http://typo3.org/extensions/extension-keys/>`_ (login in `typo3.org <http://typo3.org//>`_ required).
...
.. _content-element-preview-renderer:

Content Element Preview Renderer
--------------------------------

The preview renderer (``NewContentElementPreviewRenderer.php``), for the backend, has been put in the directory
``Classes/Hooks/PageLayoutView`` and could look like this
